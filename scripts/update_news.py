...
def classify(text, fallback="Мир"):
    value = " " + text.lower() + " "
    rules = [
        ("Технологии", [" openai ", " gpt", " apple ", " google ", " microsoft ", "технолог", "нейросет", "искусственн", "робот", "чип", "стартап", "смартфон", "кибер", "программ"]),
        ("Бизнес", ["банк", "рынок", "акци", "эконом", "бизнес", "нефт", "рубл", "доллар", "инфляц", "компани", "бирж", "цб "]),
        ("Наука", ["наука", "исследован", "космос", "nasa", "spacex", "учен", "лаборатор", "физик", "биолог"]),
        ("Культура", ["кино", "музык", "культур", "фильм", "сериал", "театр", "книга", "актер", "актёр"]),
        ("Здоровье", ["здоров", "медицин", "врач", "болезн", "лекарств", "пациент"]),
        ("Спорт", ["спорт", "футбол", "хоккей", "теннис", "formula", "олимп", "матч", "чемпион"])
    ]
    if re.search(r"(^|\\W)ии(\\W|$)", value):
        return "Технологии"
